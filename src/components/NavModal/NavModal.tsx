        ...
        anime.timeline({
            ...
            begin: () => {
                if (document.querySelectorAll('iframe')[0]) {
                    document.querySelectorAll('iframe')[0].style.opacity = "0";
                }
            },
            complete: () => {
        ...
        <div className="navModal-container">
            {showChildren && (
                <>
                    ...
                    <div className="navModal-social-links">
                        <a href="https://github.com/IshraqKabir" aria-label="Github" target="_blank" rel="noreferer">
                            <svg role="image" className="navModal-social-link-svg" viewBox="0 0 438.549 438.549">
                                <title>Github</title>
                        ...
                        <a href="https://linkedin.com/in/ishraq-kabir" aria-label="Github" target="_blank" rel="noreferer">
                            <svg role="image" className="navModal-social-link-svg" viewBox="0 0 438.549 438.549">
